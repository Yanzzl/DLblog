...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--st_root', type=str, default=path_colab.train_path_ST, help='path to structure images')
        # parser.add_argument('--de_root', type=str, default=r'./data/datasets/images', help='path to detail images (which are the groundtruth)')
        parser.add_argument('--de_root', type=str, default=path_colab.train_path_DE, help='path to detail images (which are the groundtruth)')
        ...
        parser.add_argument('--mask_root', type=str, default=path_colab.train_path_MASK, help='path to mask, we use the datasetsets of partial conv hear')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default=path_colab.checkpoints_dir, help='models are saved here')
